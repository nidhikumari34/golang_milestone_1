...
//inserting 1 row at a time in netflix_show_details table
func InsertRowsJSON(db *sql.DB, p Netflix_shows) error {
	...
	log.Printf("InsertShowsJSON")
	return nil
}

func InsertShowsJSON(r *http.Request, db *sql.DB, netflix_titles [][]string) error {
	var err error
